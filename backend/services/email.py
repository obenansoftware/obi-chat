...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Obi Chat Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Obi Chat — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Kortix Obi Chat</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Kortix Obi Chat Logo" class="logo">
    </div>
    <h1>Welcome to Kortix Obi Chat!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Kortix Obi Chat — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Obi Chat community <span class="emoji">🌞</span></p>

    <p>— The Obi Chat Team</p>

    <a href="https://www.chat.obenan.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Obi Chat — we're excited to have you on board!
...
Thanks again, and welcome to the Obi Chat community 🌞

— The Obi Chat Team

Go to the platform: https://www.chat.obenan.ai/

---
© 2024 Obi Chat. All rights reserved.
You received this email because you signed up for a Obi Chat account."""
