...
- is_suna_default: boolean - Whether this is the official Obi Chat default agent
- centrally_managed: boolean - Whether this agent is managed centrally by Obi Chat
