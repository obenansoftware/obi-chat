...
-- Create RPC function to find Obi Chat default agent for an account
...
-- Create function to get all Obi Chat default agents
...
-- Create function to get Obi Chat default agent statistics
...
BEGIN
    ...
    -- Get active count (all Obi Chat agents are considered active)
