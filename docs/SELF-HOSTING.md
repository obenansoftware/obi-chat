# Obi Chat Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of Obi Chat, an open-source generalist AI agent.
...
- Start Obi Chat using your preferred method
...
Obi Chat can be started in two ways:
...
For further assistance, join the [Obi Chat Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/obenan/obi-chat) for updates and issues.
