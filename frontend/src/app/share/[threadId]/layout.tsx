...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix Obi Chat',
    description: 'Replay this Agent conversation on Kortix Obi Chat',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix Obi Chat';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix Obi Chat';
