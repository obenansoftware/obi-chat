                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the Obi Chat website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Obi Chat website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Obi Chat is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Obi Chat logos, marks, and designations are trademarks or
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Obi Chat in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Obi Chat does not collect biometric or identifying
